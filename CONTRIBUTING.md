...
Participation is expected to be consistent with our [Code of Conduct](https://github.com/cosai-oasis/oasis-open-project/blob/main/CODE-OF-CONDUCT.md), the licenses applicable for each repository, and the acceptance of our [Contributor License Agreement](https://www.oasis-open.org/open-projects/cla/), generally at the time of first contribution. 
